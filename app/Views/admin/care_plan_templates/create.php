  ...
  <div class="container-fluid">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Crear Plan de Cuidado Estandarizado</h3>
      </div>
      <div class="card-body">
        ...
        <form action="<?= base_url('admin/care-plan-templates/store') ?>" method="POST" id="formCreateTemplate">
            ...
            <div class="form-group col-md-6">
              ...
              <select id="tipo_diagnostico_id" name="tipo_diagnostico_id" class="form-control" required>
                ...
                <?php foreach ($diagnosisTypes as $dt): ?>
                  <option value="<?= $dt['tipo_diagnostico_id'] ?>"
                    <?= old('tipo_diagnostico_id') == $dt['tipo_diagnostico_id'] ? 'selected' : '' ?>>
                    <?= esc($dt['nombre']) ?>
                  </option>
                <?php endforeach; ?>
              </select>
